...
export const Watermark: React.FC<WatermarkProps> = ({ scenario,cameraZ }) => {
    ...
    const outroStartTime = scenario.timings.outro.start_time;
        ...
        <>
            ...
            >
                ...
                <img 
                    ...
                    alt="Channel Logo"
                    style={{
                        height: '4vh', // Responsive to view height
                        width: 'auto',
                        objectFit: 'contain',
                    }} 
                />
                ...
                <span
                    style={{
                        ...
                        color: 'teal',
                        fontWeight: 800,
                        fontSize: '2vh', // Responsive to view height
