export const THEMES = [
    { name: "Cyber Slime", bg: ["#233359", "#000000"], primary: "#00FF41", secondary: "#9D00FF", rim: "#FFFFFF" },
    { name: "Deep Indigo", bg: ["#0f0f20", "#020205"], primary: "#00F3FF", secondary: "#FF0055", rim: "#FFD700" },
    { name: "Solar Flare", bg: ["#450d0d", "#000000"], primary: "#FF4800", secondary: "#FFD500", rim: "#00FFFF" },
    { name: "Royal Gold",  bg: ["#302616", "#000000"], primary: "#FFD700", secondary: "#FFFFFF", rim: "#FF00FF" },
