...
CMD="npx remotion render src/index.ts NCERT-Shorts-FACT $TEMP_OUT --concurrency=1 --enable-multiprocess-on-linux --log=verbose --chromium-options=\" --enable-unsafe-swiftshader --gl=angle \" " 
